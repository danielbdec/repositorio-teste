...
export const PHENOLOGY_STAGES: PhenologicalStage[] = [
    { id: 'VE', label: 'VE', fullLabel: 'Emergência', weekOffset: 0, dae: 0, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'V1', label: 'V1', fullLabel: 'Primeiro Nó', weekOffset: 1, dae: 7, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'V2', label: 'V2', fullLabel: 'Segundo Nó', weekOffset: 2, dae: 14, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'V4', label: 'V4', fullLabel: 'Quarto Nó', weekOffset: 3, dae: 21, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'V6', label: 'V6', fullLabel: 'Sexto Nó', weekOffset: 4, dae: 28, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'V8', label: 'V8', fullLabel: 'Oitavo Nó', weekOffset: 5, dae: 35, phase: 'VEGETATIVA', color: 'text-agri-green-700' },
    { id: 'R1', label: 'R1', fullLabel: 'Início Floração', weekOffset: 6, dae: 42, phase: 'REPRODUTIVA', color: 'text-amber-600' },
    { id: 'R2', label: 'R2', fullLabel: 'Floração Plena', weekOffset: 7, dae: 49, phase: 'REPRODUTIVA', color: 'text-amber-600' },
    { id: 'R3', label: 'R3', fullLabel: 'Início Vagem', weekOffset: 8, dae: 56, phase: 'REPRODUTIVA', color: 'text-amber-600' },
    { id: 'R4', label: 'R4', fullLabel: 'Vagem Plena', weekOffset: 9, dae: 63, phase: 'REPRODUTIVA', color: 'text-amber-700' },
    { id: 'R5', label: 'R5', fullLabel: 'Enchimento Grão', weekOffset: 10, dae: 70, phase: 'REPRODUTIVA', color: 'text-orange-600' },
    { id: 'R5.5', label: 'R5.5', fullLabel: 'Enchimento Avançado', weekOffset: 12, dae: 84, phase: 'REPRODUTIVA', color: 'text-orange-700' },
    { id: 'R7', label: 'R7', fullLabel: 'Maturidade Fisiológica', weekOffset: 14, dae: 98, phase: 'REPRODUTIVA', color: 'text-orange-700' },
    { id: 'R8', label: 'R8', fullLabel: 'Maturidade Colheita', weekOffset: 16, dae: 112, phase: 'REPRODUTIVA', color: 'text-red-600' },
];
...
export function getPhaseColors(phase: 'VEGETATIVA' | 'REPRODUTIVA') {
    return phase === 'VEGETATIVA'
        ? { bg: 'bg-agri-green-500', text: 'text-agri-green-700', border: 'border-agri-green-700/30', bgLight: 'bg-agri-green-50', line: 'bg-agri-green-500/40' }
        : { bg: 'bg-amber-500', text: 'text-amber-700', border: 'border-amber-500/30', bgLight: 'bg-amber-50', line: 'bg-amber-500/40' };
}
